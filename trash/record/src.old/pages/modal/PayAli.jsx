  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="rp-pay rp-pay--ali   rc-flex rc-items--center" >
          ...
          <div className="rc-cover--w">
            <div className='rp-pay--inner'>
                    ...
                    <div className="rp-ratio__outer" data-ratio='100%'>
                      ...
                      <div className='rp-ratio__inner rp-ratio--up rc-flex--center'>
                        <div className='rp-pay--icon' >
                          <img src={require('../../images/pay-ali.png')} alt="" className='rp-img--icon rp-img--pay' />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className='rc-padding__lg rp-text--ali rc-text--bold rc-text--center'>
                打开支付宝[扫一扫]
        </div>
            </div>
