...
export const getQr = ( accessToken ) =>{
  ...
  return function getMessage(dispatch,getState){
    ...
    http.fly.post(configs['PROD_HTTP'] + '/pay/getQr.do',{ accessToken }).then((response)=>{

      let data = response['data'];
      if(data){
        let decrypt = http.crypt.decrypt(data)
...
export const getStatus = (accessToken) =>{
  return (dispatch,getState) =>{ 
    ...
    http.fly.post(configs['PROD_HTTP'] + '/pay/paySuccess.do',{ accessToken }).then((response)=>{
